...
public interface UserRepository extends JpaRepository<User, Long> {
    @Query("select u.studentNumber as studentNumber, r.major.majorName as majorName, u.result as result, u.takenStatus as takenStatus, r.name as name, r.semester as semester " +
